...
class ArmorDataProviderImpl @Inject constructor(private val armorInteractor: GetArmorInteractor) : ViewDataProvider(), ArmorDataProvider {
    ...
    private val mappedArmorSets
        get() = armorInteractor.getArmor()
            ...
            .compose(ResourceTransformer.fromSingle())
            .toObservable()
